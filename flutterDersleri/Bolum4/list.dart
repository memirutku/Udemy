...
void main(List<String> args) {
  ...
  List<int> numaralar = List.filled(
    10,
    0,
  ); // 10 eleman içeren sabit uzunluklu liste yani dizi.
  ...
  List<dynamic> dinamikListe2 = List<dynamic>.filled(
    10,
    0,
  ); // Filled den önce de dynamic yazılabilir.

  List<String> isimler2 = List.filled(
    10,
    "",
    growable: false,
  ); //growable: false ile sabit uzunluklu liste oluşturulur. eğer growable: true yazılırsa dinamik uzunluklu liste oluşturulur.
